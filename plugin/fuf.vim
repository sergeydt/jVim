...
function s:initialize()
  "---------------------------------------------------------------------------
  call l9#defineVariableDefault('g:fuf_modesDisable'     , [ 'mrucmd', ])
  call l9#defineVariableDefault('g:fuf_keyOpen'          , '<cr>')
  call l9#defineVariableDefault('g:fuf_keyOpenSplit'     , '<k1>s')
  call l9#defineVariableDefault('g:fuf_keyOpenVsplit'    , '<k1>d')
  call l9#defineVariableDefault('g:fuf_keyOpenTabpage'   , '<k1><tab>')
  call l9#defineVariableDefault('g:fuf_keyPreview'       , '<k3>')
