...
if !exists('g:user_zen_leader_key')
  let g:user_zen_leader_key = '<k1>'
endif

function! s:install_plugin()
  for item in [
  \ {'mode': 'i', 'var': 'user_zen_expandabbr_key', 'key': '<k9>', 'plug': 'ZenCodingExpandAbbr', 'func': '<c-g>u<esc>:call zencoding#expandAbbr(0)<cr>a'},
  \ {'mode': 'v', 'var': 'user_zen_expandabbr_key', 'key': '<k9>', 'plug': 'ZenCodingExpandVisual', 'func': ':call zencoding#expandAbbr(2)<cr>'},
  \ {'mode': 'n', 'var': 'user_zen_expandabbr_key', 'key': '<k9>', 'plug': 'ZenCodingExpandNormal', 'func': ':call zencoding#expandAbbr(3)<cr>'},
  \ {'mode': 'i', 'var': 'user_zen_expandword_key', 'key': '\;', 'plug': 'ZenCodingExpandWord', 'func': '<c-g>u<esc>:call zencoding#expandAbbr(1)<cr>a'},
  \ {'mode': 'n', 'var': 'user_zen_expandword_key', 'key': '<k9>', 'plug': 'ZenCodingExpandWord', 'func': ':call zencoding#expandAbbr(1)<cr>'},
  ...
  \ {'mode': 'i', 'var': 'user_zen_prev_key', 'key': 'b', 'plug': 'ZenCodingPrev', 'func': '<esc>:call zencoding#moveNextPrev(1)<cr>'},
  \ {'mode': 'n', 'var': 'user_zen_prev_key', 'key': 'b', 'plug': 'ZenCodingPrev', 'func': ':call zencoding#moveNextPrev(1)<cr>'},
  ...
  \ {'mode': 'i', 'var': 'user_zen_togglecomment_key', 'key': 'F', 'plug': 'ZenCodingToggleComment', 'func': '<esc>:call zencoding#toggleComment()<cr>a'},
  \ {'mode': 'n', 'var': 'user_zen_togglecomment_key', 'key': 'F', 'plug': 'ZenCodingToggleComment', 'func': ':call zencoding#toggleComment()<cr>'},
