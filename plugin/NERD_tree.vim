...
call s:initVariable("g:NERDTreeAutoCenter", 0)
...
call s:initVariable("g:NERDTreeMapActivateNode", "a")
call s:initVariable("g:NERDTreeMapChangeRoot", "d")
...
call s:initVariable("g:NERDTreeMapJumpFirstChild", "<right>")
...
call s:initVariable("g:NERDTreeMapOpenSplit", "q")
call s:initVariable("g:NERDTreeMapOpenVSplit", "e")
call s:initVariable("g:NERDTreeMapPreview", "g" . NERDTreeMapActivateNode)
call s:initVariable("g:NERDTreeMapPreviewSplit", "g" . NERDTreeMapOpenSplit)
call s:initVariable("g:NERDTreeMapPreviewVSplit", "g" . NERDTreeMapOpenVSplit)
call s:initVariable("g:NERDTreeMapQuit", "<c-q>")
...
call s:initVariable("g:NERDTreeMapUpdir", "<c-d>")
