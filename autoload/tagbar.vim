...
function! s:MapKeys()
    ...
    nnoremap <script> <silent> <buffer> <a-s>    :call <SID>ToggleSort()<CR>
    nnoremap <script> <silent> <buffer> x    :call <SID>ZoomWindow()<CR>
    nnoremap <script> <silent> <buffer> <a-q>    :call <SID>CloseWindow()<CR>
    nnoremap <script> <silent> <buffer> <a-F1> :call <SID>ToggleHelp()<CR>
endfunction
